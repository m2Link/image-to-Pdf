...
This bot created by @ask_admin01""",reply_to_message_id = message.message_id ,  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/m2botzsupport") ],
                 [InlineKeyboardButton("Channel🧐", url="https://t.me/m2botz") ]       ]        ) )
